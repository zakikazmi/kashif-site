...
For tips on how to speed up image loading time, check out`,"google-analytics-for-wordpress"),u("this helpful guide","google-analytics-for-wordpress"))}},getTbtDescription(){const s=this.getSiteSpeedData().total_blocking_time;return{id:4,score:s.score,icon:this.getStatIcon(s.score),title:j(u("Total Blocking Time - %s","google-analytics-for-wordpress"),s.value),details:j(`<p>%1$s</p>
						<p><strong>%2$s </strong>%3$s</p>
						<h2>%4$s</h2>
